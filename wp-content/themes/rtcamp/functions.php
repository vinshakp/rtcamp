...
if ( ! function_exists( 'rtcamp_setup' ) ) :
	...
	function rtcamp_setup() {
		...
		register_nav_menus( array(
			...
			'menu-2' => esc_html__( 'security menu', 'rtcamp' ),
			'menu-3' => esc_html__( 'Footer menu', 'rtcamp' ),
		) );
...
function rtcamp_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'FooterWidget', 'rtcamp' ),
		'id'            => 'footerwidget-1',
		'description'   => esc_html__( 'Add widgets here.', 'rtcamp' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
// Widget description
array( 'description' => __( 'Widget for social media icons', 'wpb_widget_domain' ), ) 
);
}
...
if ( ! empty( $fb ) )
echo "<a href='$fb'><span class='sm facebook'>Facebook</span></a>";

if ( ! empty( $twitter ) )
echo "<a href='$twitter'><span class='sm twitter'>Twitter</span></a>";

if ( ! empty( $linkedin ) )
echo "<a href='$linkedin'><span class='sm linkedin'>LinkedIn</span></a>";

if ( ! empty( $rss ) )
echo "<a href='$rss'><span class='sm rss'>RSS</span></a>";
